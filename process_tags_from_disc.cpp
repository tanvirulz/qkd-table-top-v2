/*
This is a small example of how to read the raw Tag format from a dump file in C++.
For post-processing, a start-stop measurement is implemented for the channels 1-2.
An example file with 16M events can be generated with this python code:
...
IteratorBase. Such an example is shown within the CustomMeasurement example files.
*/
